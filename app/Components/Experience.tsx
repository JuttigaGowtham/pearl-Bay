        ...
        <div className="relative max-w-[1050px] ml-auto">
          ...
          >
            <div className="max-w-xl text-lg lg:text-2xl leading-relaxed font-[cursive]">
              <p className="mb-6">
                Experiences at Pearl Bay are thoughtfully curated to connect
                guests with nature, culture, and moments of quiet wonder.
              </p>

              <p className="mb-6">
                From immersive activities to serene discoveries, each experience
                unfolds at a gentle, intentional pace.
              </p>

              <p className="mb-6">
                Here, time slows down—allowing space for reflection,
                inspiration, and meaningful connection.
              </p>
            </div>
